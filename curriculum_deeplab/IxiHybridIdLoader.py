...
class IxiHybridIdLoader(HybridIdLoader):
...
def get_ixi_data_load_closure(base_dir, domain, state, use_additional_data, size, resample, normalize, crop_3d_w_dim_range, ensure_labeled_pairs, debug):
